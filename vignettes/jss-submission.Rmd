...
Let $\{ Y_{it} \colon i = 1, 2 \ldots k, t = 1, 2, \ldots, T \}$ be the daily time series of $i$-th variable at $t$-th time point and let $\bfY_t \defn (Y_{1t}, Y_{2t}, \ldots, Y_{kt})^\tr$ be a $k$-dimensional vector at time $t$. We formulate VAR model of lag $p$ as follows.
