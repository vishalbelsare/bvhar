...
title:
  formatted: "Modeling and Forecasting Multivariate Time Series Using \\pkg{bvhar} Package in \\proglang{R}"
  # If you use tex in the formatted title, also supply version without
  plain:     "Modeling and Forecasting Multivariate Time Series Using bvhar Package in R"
  # For running headers, if needed
  short:     "\\pkg{bvhar}: Modeling and Forecasting Multivariate Time Series"
abstract: >
  The abstract of the article.
keywords:
  # at least one keyword must be supplied
  formatted: [vector autoregressive model, vector heterogeneous autoregressive model, bayesian econometrics, time series, forecast, structural analysis, "\\proglang{RcppEigen}", "\\proglang{R}"]
  plain:     [vector autoregressive model, vector heterogeneous autoregressive model, bayesian econometrics, time series, forecast, structural analysis, RcppEigen, R]
preamble: >
  \usepackage{amsmath}
...
<!-- ## Structural analysis {#sec:structural short-title="structural"}

## Forecasting {#sec:forecast short-title="forecasting"} -->

# The \pkg{bvhar} package {#sec:bvharpkg short-title="package"}

# Empirical Analysis: CBOE ETF Volatility Index {#sec:analysis short-title="example"}
...
## Analyzing with frequentist models
